...
int main() {
	...
	*/
	...
	printf("Kitabın sayfa miktari: ");
	scanf("%s",kitapsayfasayisi);
	
	printf("Okudugu sayfa miktari: ");
	scanf("%s",kitapokunansayfasayisi);
	
	printf("Merhaba, %s adli yazarın %s sayfalık bir eseri olan %s'i tam olarak %s sayfa okumussunuz",kitapyazari,kitapsayfasayisi,kitapadi,kitapokunansayfasayisi);
